  ...
  >
    ...
    >
      ...
      <el-form-item label="所属分类" prop="catelogId">
        ...
        <el-cascader v-model="dataForm.catalogPath" :options="categorys"  placeholder="试试搜索：蓝牙" filterable :props="props"></el-cascader>
          ...
          if (this.dataForm.attrGroupId) {
            this.$http({
              ...
              if (data && data.code === 0) {
                ...
                //查出catelogId的完整路径
                this.dataForm.catalogPath = data.attrGroup.catelogPath
              }
            })
          }
        })
